                ...
                <div className="max-w-7xl mx-auto px-6 py-6">
                    ...
                    >
                        {[
                            ...
                            { value: APPLICATION_STATUS.REJECTED, label: "Отклоненные", icon: getStatusIcon(APPLICATION_STATUS.REJECTED) },
                                        ...
                                        <div className="flex items-center gap-2">
                                            {app.statusName === APPLICATION_STATUS.NEW && (
                                                <>
                                                    ...
                                                    <motion.button
                                                        ...
                                                        whileTap={{ scale: 0.95 }}
                                                        onClick={() =>
                                                            router.push(`/employer/resumes/${app.resumeId}`)
                                                        }
                                            ...
                                            {app.statusName !== APPLICATION_STATUS.NEW && (
                                                <motion.button
                                                    ...
                                                    className="px-4 py-2 rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors"
                                                >
